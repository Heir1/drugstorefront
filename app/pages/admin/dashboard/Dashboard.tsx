            ...
            <div className="grid grid-cols-12 mt-6 mb-10 ">
                <div className="col-start-2 col-span-10 px-20 " >
                    <div className="grid grid-cols-12 gap-5 ">
                        <Link className='col-span-2' href={`/pages/admin/rapport/lowstockarticle`} >
                            <div className=" px-5 py-4 space-y-20 bg-white rounded-3xl shadow-[0px_4px_8px_0px_#00000026]" >
                        ...
                        <Link className='col-span-2' href={`/pages/admin/rapport/expiredarticle`} >
                        ...
                        <Link className='col-span-2' href={`/pages/admin/rapport/articles`} >
                            <div className="col-span-2 px-5 py-4 space-y-20 bg-white rounded-3xl shadow-[0px_4px_8px_0px_#00000026]" >
                                <div className="flex justify-between items-center " >
                                    <div>
