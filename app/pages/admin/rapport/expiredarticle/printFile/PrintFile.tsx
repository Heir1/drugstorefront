...
export default function PrintFile({articles, totalPurchase, totalSelling}:Articleprops) {
    ...
    return (
        <div className="flex flex-col items-center space-y-2 pt-4 ">
            ...
            <div className="w-full px-4" >
                <div className="grid grid-cols-3 border-b-2 border-gray-700 pb-2" >
            ...
            <div className="w-full px-4" >
                <div className=" flex justify-center mt-2 " >
                    <h1 className="font-bold">ALERTE DE PEREMPTION</h1>
                </div>
                <div className="grid grid-cols-6 border-t-2 border-b-2 border-gray-700" >
                ...
                </div>
                {
                    articles.map((article:IArticle) => (
                        <div key={article.id} className="grid grid-cols-6 border-b-[1px] border-gray-500" >
                            <div className="w-full" >
