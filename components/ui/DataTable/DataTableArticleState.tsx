...
import ArticleActivationFormNull from "@/app/components/form/formstate/ArticleActivationFormNull";
...
export function DataTableArticleState<TData, TValue>({
    columns,
    data,
    needFilter,
    title,
    ...
    return (
        <>
            <div className=" h-[80vh] flex flex-col justify-between  " >
                    ...
                    <div className="rounded-md h-[45vh] bg-white mx-5 border-2 border-black overflow-y-auto  ">
                        ...
                        <TableHeader>
                            ...
                            <TableRow  key={headerGroup.id}>
                                ...
                                return (
                                    <TableHead className={` ${index == 0 ? 'rounded-tl-lg rounded-bl-lg' : ''  } ${index == (headerGroup.headers.length-1) ? 'rounded-tr-lg rounded-br-lg' : ''  }  px-10  bg-white  font-extrabold text-[12px] text-black`} key={header.id}>
                ...
                {
                    activationFormOpen ? (
                        <ArticleActivationForm content={article} setActivationFormOpen={setActivationFormOpen} />
                    )
                    :
                    (
                        <ArticleActivationFormNull />
                    ) 
